    ...
    return Scaffold(
      ...
      body: GetBuilder<UserController>(
        builder: (controller) {
          ...
          if (!controller.isKitIssued) {
            return _buildKitSubmissionRequired(screenWidth);
          }
          return _buildPricingSection(screenWidth, paymentService);
        },
      ),
    );
  }

  //====================== kit submission required section ======================
  Widget _buildKitSubmissionRequired(screenWidth) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Icon(Icons.warning_amber_rounded, color: Colors.orange, size: 60.sp),
          SizedBox(height: 20.h),
          CustomText(
            label: "Please Submit Your Kit Details First",
            size: 16.sp,
            color: kDark,
          ...
          CustomText(
            label:
                "You need to complete your kit issuance process before accessing plans & pricing.",
            size: 14.sp,
            color: kGrey300,
          ...
          CircularButton(
            ...
            buttonText: "Submit Kit Details",
            onPressed: () {
              Get.to(() => KitSelectionScreen());
            },
            height: 45.h,
            width: 250.w,
          ),
